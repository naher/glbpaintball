...
#include "PBMovableInVolumeObjective.h"


APBMovableInVolumeObjective::APBMovableInVolumeObjective(const class FPostConstructInitializeProperties& PCIP)
	: Super(PCIP)
{

}

FVector APBMovableInVolumeObjective::GetNextPointLocation()
{
	if (!MovementVolume)
